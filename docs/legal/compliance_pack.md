...
- **Test discipline** — 204-test daily suite across 10 gates; 7-gate full pre-release suite (golden-master matrix, adversarial edge cases, data-integrity run, AST contract tests); 29-test standalone HTTP API suite; post-publish cleanroom validation from PyPI.
